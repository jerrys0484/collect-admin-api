...
// TemplateColumns defines and stores column names for the table ct_template.
...
// templateColumns holds the columns for the table ct_template.
...
func NewTemplateDao(handlers ...gdb.ModelHandler) *TemplateDao {
	return &TemplateDao{
		group:    "default",
		table:    "ct_template",
